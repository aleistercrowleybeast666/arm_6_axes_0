...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : UI_FORWARD_Pin UI_BACK_Pin */
  GPIO_InitStruct.Pin = UI_FORWARD_Pin|UI_BACK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : SOFT_STOP_Pin HX711_DOUT_Pin */
  GPIO_InitStruct.Pin = SOFT_STOP_Pin|HX711_DOUT_Pin;
